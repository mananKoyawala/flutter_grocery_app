...
import 'CusPaint.dart';
import 'DialogConfig.dart';
import 'Gra.dart';
import 'PinTheme.dart';
import 'animation_Enam.dart';
import 'const.dart';
import 'hapic_Enam.dart';
import 'platform_Enam.dart';
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    blurRadius: 1,
                    offset: Offset(-1, -1),
                    color: Color.fromARGB(255, 205, 208, 215),
                    inset: true,
                  ),
                  BoxShadow(
                    blurRadius: 5,
